...
public class SwerveUtils {
     ...
     * @return The new value for `current` after performing the specified step towards the specified
     *     target.
     */
     ...
     * size.
     *
     * @param current The current or starting angle (in radians). Can lie outside the 0 to 2*PI
     *     range.
