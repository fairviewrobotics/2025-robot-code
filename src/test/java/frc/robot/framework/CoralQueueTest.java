...
class CoralQueueTest {
    ...
    void testAddToQueue() {
        ...
        CoralQueue.CoralPosition expected = new CoralQueue.CoralPosition(  new Pose2d(5.0, 7.0, Rotation2d.fromDegrees(12.0)), 1.0);
        ...
        expected = new CoralQueue.CoralPosition(  new Pose2d(13.0, 24.0, Rotation2d.fromDegrees(45.0)), 5.0);
        assertEquals(expected, coralQueue.getNext());
    }
    ...
    void testListToQueue() {
        ...
        CoralQueue.CoralPosition expected = new CoralQueue.CoralPosition(  new Pose2d(13.0, 24.0, Rotation2d.fromDegrees(45.0)), 5.0);
        assertEquals(expected, coralQueue.getNext());
